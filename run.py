...
if __name__ == '__main__':
    ...
    model_file = f"J:/HuggingFace/Depth-Anything/{args.encoder}14.pth"
    # depth_anything = DepthAnything()  # 初始化模型
    ...
    dir_path = '/mnt/share/toky/LLMs/Depth-Anything/'.format(args.encoder)
    cfg_path = os.path.join(dir_path, 'config.json')
    pth_path = os.path.join(dir_path, 'depth_anything_{}14.pth'.format(args.encoder))
